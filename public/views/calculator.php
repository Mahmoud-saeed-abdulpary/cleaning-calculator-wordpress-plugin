...
$price_per_sqm = floatval(get_option('cpc_fixed_price_per_sqm', '5.00'));
?>

<div class="cpc-calculator" id="cpc-calculator" data-price-per-sqm="<?php echo esc_attr($price_per_sqm); ?>">
    <div class="cpc-calculator-header">
        ...
        <div class="cpc-price-info">
            <span class="dashicons dashicons-money-alt"></span>
            <?php echo sprintf(esc_html__('Price: %s %s/m²', 'cleaning-price-calculator'), number_format($price_per_sqm, 2), $currency); ?>
        </div>
    </div>
        ...
        <div class="cpc-accordion-content">
            <div class="cpc-form-row">
                <div class="cpc-form-group">
                    <label><?php esc_html_e('Room Name', 'cleaning-price-calculator'); ?></label>
                    <input type="text" class="cpc-room-name" name="room_name_{{index}}" 
                           placeholder="<?php esc_attr_e('e.g., Living Room, Kitchen, Bedroom', 'cleaning-price-calculator'); ?>" required>
                </div>

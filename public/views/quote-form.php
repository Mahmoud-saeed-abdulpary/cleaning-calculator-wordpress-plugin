...
<div class="cpc-quote-form">
    ...
    <form id="cpc-quote-form-element" method="post" novalidate>
        <div class="cpc-form-group">
            ...
            <input type="text" id="cpc-name" name="name" class="cpc-form-control" required placeholder="<?php esc_attr_e('John Doe', 'cleaning-price-calculator'); ?>">
        </div>
        ...
        <div class="cpc-form-row">
            <div class="cpc-form-group">
                ...
                <input type="email" id="cpc-email" name="email" class="cpc-form-control" required placeholder="<?php esc_attr_e('john@example.com', 'cleaning-price-calculator'); ?>">
            </div>
            ...
            <div class="cpc-form-group">
                ...
                <input type="tel" id="cpc-phone" name="phone" class="cpc-form-control" required placeholder="<?php esc_attr_e('+1234567890', 'cleaning-price-calculator'); ?>">
            </div>
        </div>
        
        <div class="cpc-form-group">
            <label for="cpc-address">
                <?php esc_html_e('Address', 'cleaning-price-calculator'); ?>
            </label>
            <input type="text" id="cpc-address" name="address" class="cpc-form-control" placeholder="<?php esc_attr_e('123 Main St, City, Country', 'cleaning-price-calculator'); ?>">
        </div>
        
        <div class="cpc-form-group">
            <label for="cpc-message">
                <?php esc_html_e('Message', 'cleaning-price-calculator'); ?>
            </label>
            <textarea id="cpc-message" name="message" class="cpc-form-control" rows="4" placeholder="<?php esc_attr_e('Any additional information...', 'cleaning-price-calculator'); ?>"></textarea>
        </div>

...
class CPC_Ajax {
    ...
    public function submit_quote() {
        ...
        // Debug logging
        error_log('CPC Quote Submission - Customer Data: ' . print_r($customer_data, true));
        error_log('CPC Quote Submission - Rooms Data Raw: ' . $_POST['rooms']);
        error_log('CPC Quote Submission - Rooms Data Decoded: ' . print_r($rooms_data, true));
        ...
        error_log('CPC Quote Submission - Validated Rooms: ' . print_r($validated_rooms, true));
        ...
        error_log('CPC Quote Submission - Quote ID: ' . $quote_id);

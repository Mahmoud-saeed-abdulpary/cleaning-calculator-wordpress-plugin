...
class CPC_Settings {
    ...
    public function register_settings() {
        ...
        register_setting('cpc_company_settings', 'cpc_fixed_price_per_sqm'); // NEW
    ...
    public function save_settings() {
        ...
        // NEW: Fixed price per square meter
        if (isset($_POST['cpc_fixed_price_per_sqm'])) {
            update_option('cpc_fixed_price_per_sqm', floatval($_POST['cpc_fixed_price_per_sqm']));
        }

...
$fixed_price = get_option('cpc_fixed_price_per_sqm', '5.00');
?>
...
<div class="wrap cpc-admin-wrap">
    ...
    <div class="cpc-dashboard-stats">
        ...
        <div class="cpc-stat-box">
            ...
            <div class="cpc-stat-content">
                <h3><?php echo number_format($fixed_price, 2) . ' ' . esc_html($currency); ?></h3>
                <p><?php esc_html_e('Price per m²', 'cleaning-price-calculator'); ?></p>
            </div>
        </div>
